...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    transferMoney: function transferMoney() {
      ...
      this.$store.dispatch('transfer', this.transfer).then(function () {
        _this2.getWallet();
            ...
            _c("Card", { staticClass: "row" }, [
              ...
              _vm.wallet
                ? _c("div", { staticClass: "column money" }, [
                    ...
                    _c("span", { staticClass: "text" }, [
                      _c("h1", [
                        _vm._v(_vm._s(_vm.wallet.current_balance) + ".00")
                      ])
                    ])
                  ])
                : _vm._e()
                  ...
                  _vm._l(_vm.history, function(x, i) {
                    return _c("Card", { key: i, attrs: { height: "30px" } }, [
                      _c("div", { staticClass: "row between" }, [
                        _c("span", [
                          _vm._v("Amount: "),
                          _c("strong", [_vm._v(_vm._s(x.amount))])
                        ]),
                        _vm._v(" "),
                        _c("small", [
                          _vm._v("Receiver: " + _vm._s(x.recipient))
                        ])
                      ])
                    ])
                  }),
