...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      ...
      this.$store.dispatch('loginUser', this.form).then(function (res) {
        console.log(res);

        if (res.error) {
          notiflix__WEBPACK_IMPORTED_MODULE_1__["Notify"].Failure(res.msg);
          return false;
        }

        notiflix__WEBPACK_IMPORTED_MODULE_1__["Notify"].Success('Logged in Successfully');
        ...
        [
          [
            ...
            _c("small", { staticStyle: { color: "#CCC" } }, [
              _vm._v("Enter your registered details")
            ]),
            _vm._v(" "),
            _c(
              "form",
